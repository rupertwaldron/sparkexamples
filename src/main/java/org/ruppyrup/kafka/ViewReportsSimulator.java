...
public class ViewReportsSimulator 
{
	public static void main (String[] args) throws InterruptedException, FileNotFoundException
	{
		...
		Scanner sc = new Scanner(new FileReader("src/main/resources/data/kafka/final_viewing_figures"));
		int milliseconds = 0;
		while (sc.hasNextLine())
		{
			String[] input = sc.nextLine().split(",");
			Integer timestamp = Integer.valueOf(input[0]);
			Integer courseKey = Integer.valueOf(input[1]);
